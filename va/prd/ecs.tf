...
resource aws_appautoscaling_target this {
  min_capacity       = local.services.main.autoscaling.min_capacity
  max_capacity       = local.services.main.autoscaling.max_capacity
  resource_id        = "service/${data.aws_ecs_cluster.this.cluster_name}/${aws_ecs_service.this.name}"
  role_arn           = data.aws_iam_role.scaling.arn
...
resource aws_appautoscaling_policy this {
  ...
  target_tracking_scaling_policy_configuration {
    ...
    target_value       = local.services.main.autoscaling.cpu.target_value
    scale_in_cooldown  = local.services.main.autoscaling.cpu.scale_in_cooldown
    scale_out_cooldown = local.services.main.autoscaling.cpu.scale_out_cooldown
  }
